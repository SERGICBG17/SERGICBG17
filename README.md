...
&nbsp;
[![GitHub](https://img.shields.io/badge/GITHUB-SERGICBG17-181717?style=for-the-badge&logo=github)](https://github.com/SERGICBG17)
...
```
Técnico Superior en DAM con experiencia en desarrollo de aplicaciones
...
[![Ver Repositorio](https://img.shields.io/badge/Ver_Repositorio-3b82f6?style=flat-square&logo=github&logoColor=white)](https://github.com/SERGICBG17/Portfolio)

CV web interactivo con panel de administración CRUD completo, Spring Security y envío de correos SMTP.

`Java` `Spring Boot` `MySQL` `Thymeleaf` `Spring Security`
...
### App Android con PokeAPI
[![Ver Repositorio](https://img.shields.io/badge/Ver_Repositorio-3b82f6?style=flat-square&logo=github&logoColor=white)](https://github.com/SERGICBG17/PokeApi)

Aplicación móvil con Firebase Authentication y consumo de API REST.

`Kotlin` `Android SDK` `Firebase` `Retrofit`

</td>
<td width="50%">

### Sistema Monitorización Sensores
[![Ver Repositorio](https://img.shields.io/badge/Ver_Repositorio-3b82f6?style=flat-square&logo=github&logoColor=white)](https://github.com/SERGICBG17/MonitorizacionDeSensores)

Sistema distribuido cliente-servidor con UDP, TCP y Multicast.

`Java` `Sockets` `UDP/TCP` `Multithreading`
...
[![Ver Repositorio](https://img.shields.io/badge/Ver_Repositorio-3b82f6?style=flat-square&logo=github&logoColor=white)](https://github.com/SERGICBG17/EstacionamientoInteligente)

Simulador con concurrencia y semáforos.

`Java` `Concurrencia` `Semáforos`
